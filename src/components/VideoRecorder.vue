<template>
    <v-card class="cp-light-1">
        <v-toolbar class="bg-0" dense>
            ...
            >REC</v-btn>
            <v-btn v-else icon fab small color="#de112e" @click="stopRecording('video1')">stop</v-btn>
            <!-- <v-btn class="mx-2" fab dark small="true" color="primary">
	...
	export default {
		...
		methods: {
			...
			processVideo(audioVideoWebMURL: any) {
				...
				this.recRTC.getDataURL((dataURL: any) => {
					// TODO
					return;
				});
			},
